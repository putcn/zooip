...
//	}
	...
	if(index != m_nSelectedAniIndex)
	{
		[leftUpImageView removeFromSuperview];
		[rightUpImageView removeFromSuperview];
		DataModelAnimal *serverAnimalDataleft = (DataModelAnimal *)[[DataEnvironment sharedDataEnvironment].animals objectForKey:leftAnimalID];
		DataModelAnimal *serverAnimalDataRight = (DataModelAnimal *)[[DataEnvironment sharedDataEnvironment].animals objectForKey:rightAnimalID];

		leftUpImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@.png",serverAnimalDataleft.picturePrefix]]];
        rightUpImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:[NSString stringWithFormat:@"%@.png",serverAnimalDataRight.picturePrefix]]];
