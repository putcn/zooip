...
{	
	if ((self = [super init])) {
		...
		//stand textures
		CCTexture2D *standUp = [ [CCTexture2D alloc] initWithImage: [UIImage imageWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"pheasant_stand_left.png" ofType:nil]]];
		CCTexture2D *standDown = [ [CCTexture2D alloc] initWithImage: [UIImage imageWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"pheasant_stand_right.png" ofType:nil]]];
