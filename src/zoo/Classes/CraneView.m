...
{	
	if ((self = [super init])) {
		...
		animationTable = [imageProp animationTable:@"_Crane_1.png" plistName:@"_Crane_1.plist"];
		animationTable = [imageProp animationTable:@"_Crane_2.png" plistName:@"_Crane_2.plist"];
