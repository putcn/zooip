...
{	
	if ((self = [super initWithPrefix:prefix])) {
		...
		for (int i = 1; i<=29; i++) {
			...
			[walkLeftUpAnimation addFrameWithFilename:[NSString stringWithFormat:@"chinemy_walk_leftUp_%02d.png", i]];
			[walkLeftDownAnimation addFrameWithFilename:[NSString stringWithFormat:@"chinemy_walk_leftDown_%02d.png", i]];
