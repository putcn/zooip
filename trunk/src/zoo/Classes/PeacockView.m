...
{	
	if ((self = [super init])) {
		...
		animationTable = [imageProp animationTable:@"_Peacock_1.png" plistName:@"_Peacock_1.plist"];
		animationTable = [imageProp animationTable:@"_Peacock_2.png" plistName:@"_Peacock_2.plist"];
