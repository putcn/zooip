...
{	
	if ((self = [super init])) {
		...
		animationTable = [imageProp animationTable:@"_BabySwan.png" plistName:@"_BabySwan.plist"];
...
//		
//		//stand textures
//		CCTexture2D *standLeft = [ [CCTexture2D alloc] initWithImage: [UIImage imageWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"babySwan.png" ofType:nil]]];
//		//add stand textures
