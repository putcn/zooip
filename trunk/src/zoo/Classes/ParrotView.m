...
{	
	if ((self = [super init])) {
		...
		NSMutableDictionary *tempDic = [imageProp animationTable:@"_Parrot.png" plistName:@"_Parrot.plist"];
...
//		//add eat animation
//		for (int i = 1; i<=34; i++) {
//			[eatAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_eat_left_%02d.png",i]];
//		}
...
//			[walkLeftDownAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_walk_leftDown_%02d.png", i]];
//			[walkLeftAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_walk_left_%02d.png", i]];
//		}
...
//			[flyLeftDownAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_fly_leftDown_%02d.png", i]];
//			[flyLeftAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_fly_left_%02d.png", i]];
//		}
...
//			[transitionLeftDownAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_transition_leftDown_%02d.png", i]];
//			[transitionLeftAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_transition_left_%02d.png", i]];
//		}
...
//			[landingLeftDownAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_landing_leftDown_%02d.png", i]];
//			[landingLeftAnimation addFrameWithFilename:[NSString stringWithFormat:@"parrot_landing_left_%02d.png", i]];
//		}
...
//		
//		//stand textures
//		CCTexture2D *standLeft = [ [CCTexture2D alloc] initWithImage: [UIImage imageWithContentsOfFile: [[NSBundle mainBundle] pathForResource:@"parrot.png" ofType:nil]]];
//		//add stand textures
