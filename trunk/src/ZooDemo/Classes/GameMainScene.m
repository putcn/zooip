...
-(id) init
{
	...
	//	[baseContainer addChild:pan z:2];
		...
		NSMutableArray *mySceneArray = [[NSMutableArray alloc] init];
...
//		}
		NSMutableArray *friendSceneArray = [[NSMutableArray alloc] init];
...
//		
		...
		NSMutableArray *myAnimalArray = [[NSMutableArray alloc] init];
